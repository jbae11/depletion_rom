...
\begin{questions}
        ...
        \begin{solution}
         I re-trained the neural network with a 70-15-15 split, where:
         70 - training
         15 - validation for hyperparameter search (performance comparison)
         15 - test set reserved for final model
