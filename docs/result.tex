...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{2-74_31428-0.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{3-73_37925-0.png}
    \caption{Isotope by isotope prediction error percentage
             plotted for a discrete burnup and enrichment.
             }
    \label{fig:373_37925}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{4-0_31512-0.png}
    \caption{Isotope by isotope prediction error percentage
             plotted for a discrete burnup and enrichment.
             }
    \label{fig:40_31512}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{3-4_37521-0.png}
    \caption{Isotope by isotope prediction error percentage
             plotted for a discrete burnup and enrichment.}
    \label{fig:34_37521}
\end{figure}
